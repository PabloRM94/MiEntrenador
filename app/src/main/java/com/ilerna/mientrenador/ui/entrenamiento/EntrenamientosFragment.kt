...
class EntrenamientosFragment : Fragment() {
    ...
    private lateinit var LinLay_Crear: LinearLayout
    private lateinit var LinLay_Ver: LinearLayout
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        LinLay_Crear = view.findViewById(R.id.LinLay_Crear)
        LinLay_Ver = view.findViewById(R.id.LinLay_Ver)


        view.findViewById<Button>(R.id.Bttn_Entrenamiento).setOnClickListener {
            Visibilidad(LinLay_Crear)
        }
        view.findViewById<Button>(R.id.Bttn_Consulta).setOnClickListener {
            Visibilidad(LinLay_Ver)
        }
        view.findViewById<Button>(R.id.Bttn_AgregarTarea).setOnClickListener {
            mostrarOpcionesTareas()
        }

        view.findViewById<Button>(R.id.Bttn_GuardarEntreno).setOnClickListener {
            guardarEntrenamiento()
        }

        view.findViewById<Button>(R.id.Bttn_NuevoEntreno).setOnClickListener {
            nuevoEntrenamiento()
        }
    }
    ...
    private fun Visibilidad (section: LinearLayout) {
        ...
        private fun cargarEntrenamientos() {
            ...
            // Mostrar un diálogo para seleccionar tareas existentes
            ...
            private fun mostrarDialogoSeleccionarTareas() {
                ...
                // Mostrar un diálogo para agregar o editar una tarea
                @SuppressLint("MissingInflatedId")
